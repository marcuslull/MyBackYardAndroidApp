...
public class PlantRepositoryImpl implements com.mybackyard.frontend.repository.PlantRepository {
...
//    private final String baseUrl = "http://192.168.0.139:8080/api/plant";
    private final String baseUrl = "https://mybackyard-54fdfelt3a-uw.a.run.app/api/plant";
    ...
    @Override
    public String save(String plant) throws ExecutionException, InterruptedException, GeneralSecurityException, UnsupportedEncodingException {
        Request request = new Request.Builder()
                .url(baseUrl)
                .header(apiKeyName, decrypt(Base64.decode(encryptedApiKey, Base64.DEFAULT), protectionParametersPassword))
                .post(RequestBody.create(plant, mediaType))
                .build();

...
public class NoteRepositoryImpl implements com.mybackyard.frontend.repository.NoteRepository {
...
//    private final String baseUrl = "http://192.168.0.139:8080/api/note";
    private final String baseUrl = "https://mybackyard-54fdfelt3a-uw.a.run.app/api/note";
    ...
    @Override
    public String save(String note) throws ExecutionException, InterruptedException, GeneralSecurityException, UnsupportedEncodingException {
        Request request = new Request.Builder()
                .url(baseUrl)
                .header(apiKeyName, decrypt(Base64.decode(encryptedApiKey, Base64.DEFAULT), protectionParametersPassword))
                .post(RequestBody.create(note, mediaType))
                .build();

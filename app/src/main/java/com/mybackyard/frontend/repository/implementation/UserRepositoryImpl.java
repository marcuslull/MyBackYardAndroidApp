...
public class UserRepositoryImpl implements com.mybackyard.frontend.repository.UserRepository {
...
//    private final String baseUrl = "http://192.168.0.139:8080/api/user";
    private final String baseUrl = "https://mybackyard-54fdfelt3a-uw.a.run.app/api/user";
    ...
    @Override
    public String save(String user) throws ExecutionException, InterruptedException, GeneralSecurityException, UnsupportedEncodingException {
        Request request = new Request.Builder()
                .url(baseUrl)
                .header(apiKeyName, decrypt(Base64.decode(encryptedApiKey, Base64.DEFAULT), protectionParametersPassword))
                .post(RequestBody.create(user, mediaType))
                .build();

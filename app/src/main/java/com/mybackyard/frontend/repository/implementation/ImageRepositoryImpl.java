...
public class ImageRepositoryImpl implements com.mybackyard.frontend.repository.ImageRepository {
...
//    private final String baseUrl = "http://192.168.0.139:8080/api/image";
    private final String baseUrl = "https://mybackyard-54fdfelt3a-uw.a.run.app/api/image";
    ...
    @Override
    public String save(String image) throws ExecutionException, InterruptedException, GeneralSecurityException, UnsupportedEncodingException {
        Request request = new Request.Builder()
                .url(baseUrl)
                .header(apiKeyName, decrypt(Base64.decode(encryptedApiKey, Base64.DEFAULT), protectionParametersPassword))

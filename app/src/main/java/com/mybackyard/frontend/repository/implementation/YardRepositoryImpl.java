...
public class YardRepositoryImpl implements com.mybackyard.frontend.repository.YardRepository {
...
//    private final String baseUrl = "http://192.168.0.139:8080/api/yard";
    private final String baseUrl = "https://mybackyard-54fdfelt3a-uw.a.run.app/api/yard";
    ...
    @Override
    public String save(String yard) throws ExecutionException, InterruptedException, GeneralSecurityException, UnsupportedEncodingException {
        Request request = new Request.Builder()
                .url(baseUrl)
                .header(apiKeyName, decrypt(Base64.decode(encryptedApiKey, Base64.DEFAULT), protectionParametersPassword))
                .post(RequestBody.create(yard, mediaType))
                .build();
